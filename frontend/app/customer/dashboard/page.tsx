...
export default function CustomerDashboard() {
  ...
  const fetchData = async () => {
    try {
      ...
      console.log('📊 Appointments Response:', aptRes.data)
      console.log('📊 Appointments Count:', aptRes.data?.length)
      ...
      console.log('✅ State updated - Appointments count:', appointments.length)
    } catch (error) {
  ...
  console.log('🎨 Rendering appointments count:', appointments.length)
