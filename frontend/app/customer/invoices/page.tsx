...
export default function CustomerInvoicesPage() {
  ...
  const getStatusBadge = (status: string) => {
    const variants: Record<string, any> = {
      ...
      pending: { className: 'bg-stone-100 text-stone-800', label: 'Pending' },
    }
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-serif font-semibold text-stone-900">My Invoices</h1>
        <p className="text-stone-600">Your billing history at a glance</p>
      </div>
