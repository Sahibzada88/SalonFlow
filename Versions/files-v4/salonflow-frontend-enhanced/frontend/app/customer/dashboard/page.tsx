...
export default function CustomerDashboard() {
  ...
  // 'scheduled' removed - it's not a real status in the current schema
  // (see database/01_fresh_schema.sql); 'approved' is what an upcoming,
  // confirmed appointment is actually stored as.
  const upcoming = appointments.filter((a: any) => a.status === 'approved')
