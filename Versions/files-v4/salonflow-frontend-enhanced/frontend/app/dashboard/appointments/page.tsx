    ...
    <div>
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Manage your salon appointments</p>
        </div>
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4">
        ...
        <select
          className="px-3 py-1.5 border rounded-md bg-card text-sm h-9"
          value={filter}
          ...
          <Table>
            <TableHeader>
              <TableRow className="hover:bg-transparent">
                <TableHead className="text-xs font-medium text-muted-foreground uppercase tracking-wider py-3 px-4">
                  Date & Time
                </TableHead>
                <TableHead className="text-xs font-medium text-muted-foreground uppercase tracking-wider py-3 px-4">
                  Customer
                ...
                <TableHead className="text-xs font-medium text-muted-foreground uppercase tracking-wider py-3 px-4 text-right">
                  Actions
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {loading ? (
                ...
                filteredAppointments.map((apt: any) => (
                  <TableRow key={apt.id} className="hover:bg-muted">
                    <TableCell className="py-3 px-4">
                      <div className="text-sm font-medium text-foreground">{apt.date}</div>
                    ...
                    <TableCell className="py-3 px-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-foreground">{apt.customer_name || 'Unknown'}</span>
                      </div>
                    </TableCell>
